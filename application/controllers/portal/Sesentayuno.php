...
class Sesentayuno extends CI_Controller {
	...
	public function index()	{
		$this->crear_vista('portal/sesentayuno', $this->cargar_datos());
	}//end
	...
	public function crear_vista($nombre_vista=NULL, $datos=NULL){
			...
			$datos['menu_navegacion']= navegacion_portal($this->proy->PAGINA_SESENTAYUNO);
